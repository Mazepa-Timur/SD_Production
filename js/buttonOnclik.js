...
const hamburgerButtonClose = document.querySelector(
  ".HamburgerMenuButtonClose"
);
...
projectButton.addEventListener("click", () => {
  document.querySelector(".projectsFragmentMobile3").className =
    "projectsFragmentMobile3";
  document.querySelector(".projectsFragmentMobile4").className =
    "projectsFragmentMobile4";
